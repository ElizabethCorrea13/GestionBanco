...
CREATE SCHEMA `bdSistemaBanco`;

USE `bdSistemaBanco`;

/*USUARIOS*/
CREATE TABLE `bdSistemaBanco`.`usuarios` (
  `nombreUsuario_us` VARCHAR(45) NOT NULL PRIMARY KEY,
...
/* NACIONALIDADES */
CREATE TABLE `bdSistemaBanco`.`nacionalidades`(
...
CREATE TABLE IF NOT EXISTS `localidades` (
  ...
  PRIMARY KEY (`id`),
  FOREIGN KEY (`id_privincia`) REFERENCES `provincias`(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1244;

/*TIPO DE CUENTAS*/
CREATE TABLE `bdSistemaBanco`.`TipoCuentas` (
  `Id_TipoCuentas_TP`INT AUTO_INCREMENT NOT NULL PRIMARY KEY ,
  `Descripcion_TipoCuenta` VARCHAR (50) NOT NULL
);

/*TIPO DE MOVIMIENTOS*/
CREATE TABLE `bdSistemaBanco`.`TiposMovimientos`(
`TipoMovimiento_Tp` INT  NOT NULL AUTO_INCREMENT PRIMARY KEY,
`Descripcion_TipoMovimiento` VARCHAR(50) NOT NULL
);

/* CLIENTES */
CREATE TABLE `bdSistemaBanco`.`clientes` (
  ...
  `nombreUsuario_Cli` VARCHAR(45) NOT NULL,
...
CREATE TABLE `cuentas` (
    `NroCuenta_Cu` int NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `IdCliente_Cu` int NOT NULL,
    `ID_TIPOCUENTA_Cu` int NOT NULL,
    `fecha_creacion` date NOT NULL,
    `CBU` int NOT NULL,
    `saldo` DECIMAL(12, 2) NOT NULL DEFAULT 10000,
    `estado` boolean NOT NULL,
    FOREIGN KEY (`ID_TIPOCUENTA_Cu`) REFERENCES `TipoCuentas`(`Id_TipoCuentas_TP`)
);

-- Establecer el punto de inicio de AUTO_INCREMENT para NroCuenta_Cu
ALTER TABLE `cuentas` AUTO_INCREMENT = 10000;
...
CREATE TABLE `movimientos` (
  ...
  `Cbu_Origen` INT NULL,
  `Cbu_Destino` INT NULL,
  `fecha_movimiento` DATE NOT NULL,
  `Detalle` VARCHAR(50) NOT NULL,
  `Importe` DECIMAL(12, 2) NOT NULL,
  `TipoMovimiento_Mov` INT NOT NULL,
  FOREIGN KEY (`NroCuenta_Mov`) REFERENCES `cuentas`(`NroCuenta_Cu`),
  FOREIGN KEY (`TipoMovimiento_Mov`) REFERENCES `TiposMovimientos`(`TipoMovimiento_Tp`)
);
...
CREATE TABLE `prestamos` (
  ...
  `fecha_peticion` DATETIME DEFAULT NOW(), 
  `importeTotalConInteres` DECIMAL(12, 2) NOT NULL,
  `importeTotalSolicitado` DECIMAL(12, 2) NOT NULL,
  `cuota_mensual` DECIMAL(12, 2) NOT NULL,
  `cantidadCuotas` INT NOT NULL,
  `estadoPrestamo` BOOLEAN  NULL,
  `estadoPagado` BOOLEAN NOT NULL DEFAULT FALSE,
  FOREIGN KEY (`NroCuenta_Pr`) REFERENCES `cuentas`(`NroCuenta_Cu`)
);
...
CREATE TABLE `CuotasPrestamo` (
    ...
    FOREIGN KEY (`IdPrestamo`) REFERENCES `prestamos`(`Id_Prestamo`)
);


/*USUARIOS*/
INSERT INTO `bdSistemaBanco`.`usuarios` (`nombreUsuario_us`, `contrasena`, `admin`)
VALUES
('juanR', 'Juanrios1.', TRUE),
('SolM', 'SolMon1.', TRUE),
('KevinY', 'KevinPaz1.', TRUE),
('EliC', 'Correa1.', TRUE),
('juanM', 'Manuel2.', TRUE),
('juanp', 'Passw0rd!', FALSE),
('mariag', 'S3cretPwd!', FALSE),
('carlosr', 'P@ssword1!', FALSE),
('anaf', 'An@2023Pwd!', FALSE),
('luism', 'Lui$2023!', FALSE),
('sofial', 'Sof!a2023', FALSE),
('davidt', 'Dav!dPwd1', FALSE),
('lauras', 'L@ura123', FALSE),
('joser', 'Jos#1234', FALSE),
('martar', 'Mar!tA2023', FALSE),
('pedroh', 'P3dro!23', FALSE),
('luciam', 'Lu!a12345', FALSE),
('javierr', 'J@vier2023', FALSE),
('beatrizd', 'B3atriz!', FALSE),
('miguelg', 'Miguel!2023', FALSE);
...
/*TIPO CUENTAS*/
INSERT INTO `bdSistemaBanco`.`TipoCuentas` (`Descripcion_TipoCuenta`) VALUES 
('Caja de ahorro'),
('Cuenta corriente');

/*TIPO MOVIMIENTOS*/
INSERT INTO `bdSistemaBanco`.`TiposMovimientos` (`Descripcion_TipoMovimiento`) VALUES
('Alta de cuenta'),
('Alta de un préstamo'),
('Pago de préstamo'),
('Transferencia');
...
/*CLIENTES*/
INSERT INTO `bdSistemaBanco`.`clientes` (`dniCliente`,`cuil` ,`nombre` ,`apellido`,`sexo`,`nacionalidad`,`fechaNacimiento`,
  `direccion`,`localidad`,`provincia` ,`mail` ,`telefono`,`nombreUsuario_Cli` ,`contraseña` ,`cantidadCuentas`,`estado` ) 
VALUES
('33456778', '27334567782', 'Juan', 'Perez', 'Masculino', 9, '1985-05-12', 'Calle Falsa 123', 3, 1, 'juan.perez@example.com', '12345678', 'juanp', 'Passw0rd!', 2, TRUE),
('23456789', '20234567892', 'Maria', 'Gomez', 'Femenino', 9, '1990-07-24', 'Avenida Siempre Viva 456', 5, 1, 'maria.gomez@example.com', '87654321', 'mariag', 'S3cretPwd!', 2, TRUE),
('12345678', '20123456782', 'Carlos', 'Ruiz', 'Masculino', 9, '1982-02-15', 'Boulevard de los Sueños 789', 22, 1, 'carlos.ruiz@example.com', '11223344', 'carlosr', 'P@ssword1!', 2, TRUE),
('34567890', '27345678902', 'Ana', 'Fernandez', 'Femenino', 9, '1988-08-30', 'Calle de la Luna 101', 40, 1, 'ana.fernandez@example.com', '22334455', 'anaf', 'An@2023Pwd!', 3, TRUE),
('45678901', '20456789012', 'Luis', 'Martinez', 'Masculino', 9, '1992-12-05', 'Avenida del Sol 202', 55, 1, 'luis.martinez@example.com', '33445566', 'luism', 'Lui$2023!', 1, TRUE),
('56789012', '20567890122', 'Sofia', 'Lopez', 'Femenino', 9, '1995-04-18', 'Calle de las Flores 303', 55, 1, 'sofia.lopez@example.com', '44556677', 'sofial', 'Sof!a2023', 2, TRUE),
('67890123', '20678901232', 'David', 'Torres', 'Masculino', 9, '1986-03-20', 'Avenida de los Poetas 404', 55, 1, 'david.torres@example.com', '55667788', 'davidt', 'Dav!dPwd1', 1, TRUE),
('78901234', '20789012342', 'Laura', 'Sanchez', 'Femenino', 9, '1991-09-12', 'Calle del Arco Iris 505', 23, 1, 'laura.sanchez@example.com', '66778899', 'lauras', 'L@ura123', 1, TRUE),
('89012345', '20890123452', 'Jose', 'Rodriguez', 'Masculino', 9, '1989-11-21', 'Avenida de los Angeles 606', 25, 1, 'jose.rodriguez@example.com', '77889900', 'joser', 'Jos#1234', 1, TRUE),
('90123456', '20901234562', 'Marta', 'Ramirez', 'Femenino', 9, '1987-06-25', 'Calle del Mar 707', 80, 1, 'marta.ramirez@example.com', '88990011', 'martar', 'Mar!tA2023', 2, TRUE),
('01234567', '20012345672', 'Pedro', 'Hernandez', 'Masculino', 9, '1993-10-10', 'Avenida de la Libertad 808', 67, 1, 'pedro.hernandez@example.com', '99001122', 'pedroh', 'P3dro!23', 1, TRUE),
('12345679', '20123456792', 'Lucia', 'Morales', 'Femenino', 9, '1994-01-15', 'Calle de los Pinos 909', 90, 1, 'lucia.morales@example.com', '10111213', 'luciam', 'Lu!a12345', 1, TRUE),
('23456780', '20234567802', 'Javier', 'Romero', 'Masculino', 9, '1980-08-20', 'Avenida de la Paz 1010', 1, 1, 'javier.romero@example.com', '11121314', 'javierr', 'J@vier2023', 1, TRUE),
('34567891', '20345678912', 'Beatriz', 'Diaz', 'Femenino', 9, '1978-05-05', 'Calle de los Sueños 1111', 2, 1, 'beatriz.diaz@example.com', '12131415', 'beatrizd', 'B3atriz!', 2, TRUE),
('45678902', '20456789022', 'Miguel', 'Garcia', 'Masculino', 9, '1981-07-17', 'Avenida de la Luz 1212', 3, 1, 'miguel.garcia@example.com', '13141516', 'miguelg', 'Miguel!2023', 1, TRUE);


/*CUENTAS*/
INSERT INTO cuentas (IdCliente_Cu, ID_TIPOCUENTA_Cu, fecha_creacion, CBU, estado)
VALUES 
(1, 1, '2023-01-01', 10000001, 1),
(2, 2, '2023-02-01', 10000002, 1),
(3, 2, '2023-03-01', 10000003, 1),
(4, 1, '2023-04-01', 10000004, 1),
(2, 2, '2023-05-01', 10000005, 1),
(1, 1, '2023-06-01', 10000006, 1),
(5, 1, '2023-07-01', 10000007, 1),
(6, 2, '2023-08-01', 10000008, 1),
(3, 2, '2023-09-01', 10000009, 1),
(5, 1, '2023-10-01', 10000010, 1),
(6, 2, '2023-11-01', 10000011, 1),
(7, 2, '2023-12-01', 10000012, 1),
(10, 1, '2024-01-01', 10000013, 1),
(11, 2, '2024-02-01', 10000014, 1),
(12, 1, '2024-03-01', 10000015, 1),
(8, 1, '2024-03-01', 10000016, 1),
(15, 1, '2024-03-01', 10000017, 1),
(9, 1, '2024-03-01', 10000018, 1),
(13, 1, '2024-03-01', 10000019, 1),
(14, 1, '2024-03-01', 10000020, 1);


/*MOVIMIENTOS*/
INSERT INTO movimientos (NroCuenta_Mov, Cbu_Origen, Cbu_Destino, fecha_movimiento, Detalle, Importe, TipoMovimiento_Mov)
VALUES 
(10000, NULL, NULL, '2023-01-05', 'Apertura de cuenta', 10000, 1),
(10001, NULL, NULL, '2023-01-10', 'Aprobación de préstamo', 2000, 2),
(10002, NULL, NULL, '2023-01-15', 'Pago de cuota', 3000, 3),
(10003, 100003, 100004, '2023-01-20', 'Pago', 4000, 4),
(10004, NULL, NULL, '2023-01-25', 'Apertura de cuenta', 10000, 1),
(10005, NULL, NULL, '2023-02-01', 'Aprobación de préstamo', 1500.25, 2),
(10006, NULL, NULL, '2023-02-05', 'Pago de cuota', 3500, 3),
(10007, 100007, 100008, '2023-02-10', 'alquiler', 4500, 4),
(10008, NULL, NULL, '2023-02-15', 'Apertura de cuenta', 10000, 1),
(10009, NULL, NULL, '2023-02-20', 'Aprobación de préstamo', 1000, 2),
(10010, NULL, NULL, '2023-02-25', 'Pago de cuota', 2000.50, 3),
(10011, 100011, 100012, '2023-03-01', 'varios', 3000, 4),
(10012, NULL, NULL, '2023-03-05', 'Apertura de cuenta', 10000, 1),
(10013, NULL, NULL, '2023-03-10', 'Aprobación de préstamo', 5500, 2),
(10014, NULL, NULL, '2023-03-15', 'Pago de cuota', 6500, 3);

-- Inserción de registros en la tabla prestamos
INSERT INTO prestamos (NroCuenta_Pr, fecha_peticion, importeTotalConInteres, importeTotalSolicitado, cuota_mensual, cantidadCuotas)
VALUES 
(10000, '2023-01-01', 105000, 100000, 5000, 1),
(10001, '2023-02-01', 210000, 200000, 10000, 2),
(10002, '2023-03-01', 315000, 300000, 15000, 2),
(10003, '2023-04-01', 420000, 400000, 20000, 3),
(10004, '2023-05-01', 525000, 500000, 25000, 5),
(10005, '2023-06-01', 630000, 600000, 30000, 2),
(10006, '2023-07-01', 735000, 700000, 35000, 1),
(10007, '2023-08-01', 840000, 800000, 40000, 3),
(10008, '2023-09-01', 945000, 900000, 45000, 4),
(10009, '2023-10-01', 1050000, 1000000, 50000, 2),
(10010, '2023-11-01', 1155000, 1100000, 55000, 1),
(10011, '2023-12-01', 1260000, 1200000, 60000, 2),
(10012, '2024-01-01', 1365000, 1300000, 65000, 3),
(10013, '2024-02-01', 1470000, 1400000, 70000, 1),
(10014, '2024-03-01', 1575000, 1500000, 75000, 2);


INSERT INTO CuotasPrestamo (IdPrestamo, NumeroCuota, FechaVencimiento, ImporteCuota)
VALUES 
(1, 1, '2023-02-01', 5000.00),

(2, 1, '2023-03-01', 5000.00),
(2, 2, '2023-04-01', 5000.00),

(3, 1, '2023-04-01', 7500.00),
(3, 2, '2023-05-01', 7500.00),

(4, 1, '2023-05-01', 6666.67),
(4, 2, '2023-06-01', 6666.67),
(4, 3, '2023-07-01', 6666.67),

(5, 1, '2023-06-01', 5000.00),
(5, 2, '2023-07-01', 5000.00),

(6, 1, '2023-07-01', 35000.00),

(7, 1, '2023-08-01', 13333.33),
(7, 2, '2023-09-01', 13333.33),
(7, 3, '2023-10-01', 13333.33),

(8, 1, '2023-09-01', 11250.00),
(8, 2, '2023-10-01', 11250.00),
(8, 3, '2023-11-01', 11250.00),
(8, 4, '2023-12-01', 11250.00),

(9, 1, '2023-10-01', 25000.00),
(9, 2, '2023-11-01', 25000.00),

(10, 1, '2023-11-01', 55000.00),

(11, 1, '2023-12-01', 60000.00),
(11, 2, '2024-01-01', 60000.00),

(12, 1, '2024-01-01', 43333.33),
(12, 2, '2024-02-01', 43333.33),
(12, 3, '2024-03-01', 43333.34),

(13, 1, '2024-02-01', 70000.00),

(14, 1, '2024-03-01', 75000.00);
...
FOR EACH ROW
BEGIN
    INSERT INTO usuarios (nombreUsuario_us, contrasena, admin)
    VALUES (NEW.nombreUsuario_Cli, NEW.contraseña, FALSE);
END//
...
CREATE TRIGGER after_insert_prestamos
AFTER INSERT ON prestamos
FOR EACH ROW
BEGIN
    DECLARE cuota INT DEFAULT 1;
    DECLARE totalCuotas INT DEFAULT NEW.cantidadCuotas;
    DECLARE fechaVencimiento DATE;
    
    SET fechaVencimiento = NEW.fecha_peticion;
    
    WHILE cuota <= totalCuotas DO
        INSERT INTO CuotasPrestamo (IdPrestamo, NumeroCuota, FechaVencimiento, ImporteCuota)
        VALUES (NEW.Id_Prestamo, cuota, fechaVencimiento, NEW.importeTotalConInteres / totalCuotas);
...
DELIMITER //
CREATE TRIGGER after_insert_cuentas
...
DELIMITER //
CREATE TRIGGER after_update_prestamos
AFTER UPDATE ON prestamos
FOR EACH ROW
BEGIN
    IF NEW.estadoPrestamo = TRUE AND (OLD.estadoPrestamo IS NULL OR OLD.estadoPrestamo = FALSE) THEN
        INSERT INTO movimientos (
            NroCuenta_Mov, 
            fecha_movimiento, 
            Detalle, 
        ...
        VALUES (
            NEW.NroCuenta_Pr, 
            NOW(), 
            CONCAT('Aprobación de préstamo ', NEW.Id_Prestamo), 
            NEW.importeTotalSolicitado, 
            2
        );
    END IF;
END //
...
CREATE TRIGGER after_update_prestamos_update_saldo
AFTER UPDATE ON prestamos
FOR EACH ROW
BEGIN
    IF NEW.estadoPrestamo = TRUE AND (OLD.estadoPrestamo IS NULL OR OLD.estadoPrestamo = FALSE) THEN
        UPDATE cuentas
        SET saldo = saldo + NEW.importeTotalSolicitado
        WHERE NroCuenta_Cu = NEW.NroCuenta_Pr;
    END IF;
END //
...
CREATE TRIGGER after_insert_pagoCuotaPrestamo
AFTER INSERT ON CuotasPrestamo
FOR EACH ROW
BEGIN
    DECLARE importe_pago DECIMAL(12, 2);
    DECLARE cuenta_destino INT;

    -- Obtener el importe de la cuota pagada
    SELECT ImporteCuota INTO importe_pago
    FROM CuotasPrestamo
    WHERE IdCuota = NEW.IdCuota;

    -- Obtener el número de cuenta del préstamo
    SELECT NroCuenta_Pr INTO cuenta_destino
    FROM prestamos
    WHERE Id_Prestamo = NEW.IdPrestamo;

    -- Insertar movimiento de pago
    INSERT INTO movimientos (NroCuenta_Mov, fecha_movimiento, Detalle, Importe, TipoMovimiento_Mov)
    VALUES (cuenta_destino, NOW(), 'Pago de cuota del préstamo', importe_pago, 3);
END;
//
